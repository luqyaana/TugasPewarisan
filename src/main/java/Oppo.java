public class Oppo implements Phone{ //Mengimplementasikan interface dari Phone
    ...
    public Oppo() { //Konstruktor untuk menginisialisasi atribut
        this.isPowerOn = true;
        this.volume = 0;
    }
    ...
    public void powerOn() { //Metode untuk menghidupkan HP
        isPowerOn = true;
        System.out.println("Handphone Oppo berhasil dinyalakan!");
    }

    @Override
    public void poweroff() { //Metode untuk mematikan HP
        isPowerOn = false;
        System.out.println("Handphone Oppo berhasil dimatikan!");
    }
