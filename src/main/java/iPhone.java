public class iPhone implements Phone{ //Mengimplementasikan interface dari Phone
    ...
    public iPhone() { //Konstruktor untuk menginisialisasi atribut
        this.isPowerOn = true;
        this.volume = 0;
    }
    ...
    public void powerOn() { //Metode untuk menghidupkan HP
        isPowerOn = true;
        System.out.println("Handphone iPhone berhasil dinyalakan!");
    }

    @Override
    public void poweroff() { //Metode untuk mematikan HP
        isPowerOn = false;
        System.out.println("Handphone iPhone berhasil dimatikan!");
    }
