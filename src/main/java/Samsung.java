public class Samsung implements Phone { //Mengimplementasikan interface dari Phone
    ...
    public Samsung() { //Konstruktor untuk menginisialisasi atribut
        this.isPowerOn = true;
        this.volume = 0;
    }
    ...
    public void powerOn() { //Metode untuk menghidupkan HP
        isPowerOn = true;
        System.out.println("Handphone Samsung berhasil dinyalakan!");
    }

    @Override
    public void poweroff() { //Metode untuk mematikan HP
        isPowerOn = false;
        System.out.println("Handphone Samsung berhasil dimatikan!");
    }
